  ...
  "ctx_index",
  {
    ...
    inputSchema: z.object({
      ...
      source: z
        ...
        .optional()
        .describe(
          "Label for the indexed content (e.g., 'Context7: React useEffect', 'Skill: frontend-design'). MUST USE ENGLISH ONLY, NO CHINESE.",
        ),
    }),
  },
  ...
  "ctx_search",
  {
    ...
    inputSchema: z.object({
      ...
      source: z
        .string()
        .optional()
        .describe("Filter to a specific indexed source (partial match). MUST USE ENGLISH ONLY, NO CHINESE."),
      contentType: z
        .enum(["code", "prose"])
        .optional()
  ...
  "ctx_fetch_and_index",
  {
    ...
    inputSchema: z.object({
      ...
      source: z
        ...
        .optional()
        .describe(
          "Label for the indexed content (e.g., 'React useEffect docs', 'Supabase Auth API'). MUST USE ENGLISH ONLY, NO CHINESE.",
        ),
      force: z
        .boolean()
        .optional()
