export function isLowValueQuery(query: string): boolean {
  ...
  const emojiRegex = /^[\u{1F300}-\u{1F9FF}\u{2600}-\u{26FF}\u{2700}-\u{27BF}\u{1F100}-\u{1F1FF}\u{1F200}-\u{1F2FF}\s]+$/u;
...
export function filterNoise<T>(items: T[], textExtractor: (item: T) => string): T[] {
